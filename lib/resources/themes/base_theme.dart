...
ThemeData buildAppTheme(ColorStyles color, {required Brightness brightness}) {
  ...
  TextTheme textTheme = getAppTextTheme(
    ...
    defaultTextTheme.merge(_textTheme(color, isDark)),
  );
  ...
  return ThemeData(
    ...
    filledButtonTheme: FilledButtonThemeData(
      style: FilledButton.styleFrom(
        ...
        foregroundColor: isDark ? const Color(0xFF191919) : Colors.white,
    ...
    outlinedButtonTheme: OutlinedButtonThemeData(
      style: OutlinedButton.styleFrom(
        ...
        side: BorderSide(
          color: isDark ? const Color(0xFF3A3A3A) : const Color(0xFFE1DFDA),
        ),
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
        padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 14),
      ),
    ...
    inputDecorationTheme: InputDecorationTheme(
      filled: true,
      fillColor: color.general.surface,
      labelStyle: TextStyle(color: isDark ? const Color(0xFFB8B5B0) : null),
      hintStyle: TextStyle(color: isDark ? const Color(0xFF8E8B85) : null),
    ...
    dropdownMenuTheme: DropdownMenuThemeData(
      textStyle: TextStyle(color: color.general.content),
      menuStyle: MenuStyle(
        backgroundColor: WidgetStatePropertyAll(color.general.surface),
      ),
    ),
    ...
    bottomNavigationBarTheme: BottomNavigationBarThemeData(
      ...
      unselectedIconTheme: IconThemeData(
        color: color.bottomTabBar.iconUnselected,
      ),
      selectedIconTheme: IconThemeData(color: color.bottomTabBar.iconSelected),
      unselectedLabelStyle: TextStyle(
        color: color.bottomTabBar.labelUnselected,
      ),
...
TextTheme _textTheme(ColorStyles colors, bool isDark) {
  ...
  return textTheme.copyWith(labelLarge: TextStyle(color: alphaColor));
}
